  ...
  return (
    <div className="bg-[#050505] flex flex-row justify-between items-center md:py-7 md:px-10 py-5 px-10">
      ...
      <div className="md:flex md:flex-row md:gap-1 hidden ">
        <div className='cursor-pointer border border-[#4B4B4F] rounded-r-full rounded-l-full px-3 py-1 text-white text-md'>
          Home
        </div>
        <div className='cursor-pointer border border-[#4B4B4F] rounded-r-full rounded-l-full px-3 py-1 text-white text-md'>
          Chart
...
const Main = () => {
  return (
    <div className="h-screen">
      ...
      <Header />
      <div className="bg-[#050505] h-[30%]" />
      <div className="md:pt-32 pt-12 text-center px-1">
        <div className="md:font-extrabold font-bold text-transparent md:text-8xl text-5xl bg-clip-text bg-black">
          Stake with ease,
        </div>
        <div className="md:font-extrabold font-bold text-transparent md:text-8xl text-5xl bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-600">
          earn with peace
        </div>
        <div className="md:text-2xl text-lg pt-10">
      ...
      <div className="flex flex-row justify-center items-center mx-auto mt-10">
        <div className="flex flex-row gap-5">
          <div className="flex flex-row justify-center items-center gap-5 bg-black text-white p-3 rounded-r-full rounded-l-full cursor-pointer">
            Get Started
            <HiArrowUpRight />
          </div>
          <div className="bg-[#F0F1F3] p-3 rounded-r-full rounded-l-full cursor-pointer">
            Read documentation
          </div>
        </div>
      </div>
