    ...
    <div className="vector bg-[#050505]">
      <div className="mx-auto text-center">
        <div className="flex flex-row justify-center">
          <div className="absolute sm:w-[400px] h-[500px]">
        ...
        <div className="pt-10 text-2xl text-white text-[36px] sm:text-[54px] md:text-[64px] font-passenger font-extrabold relative z-10">
          Keep in touch
        </div>
        <div className="mx-auto">
          <div className="flex flex-wrap items-center justify-center gap-10 px-5 py-10 sm:px-20 md:flex-row md:py-32">
            <Media
              ...
              link="https://twitter.com/lsderivatives/"
            />
            <Media
              name="Discord"
              icon={<FaDiscord className="w-10 h-10" />}
              link="https://discord.com/invite/lsderivatives/"
            />
            <Media
              name="Medium"
              icon={<BsMedium className="w-10 h-10" />}
              link="https://lsderivatives.medium.com/"
            />
            <Media
              name="Github"
              icon={<FaGithub className="w-10 h-10" />}
              link="https://github.com/lsderivatives/"
            />
            <Media
              name="Coinmarketcap"
              icon={
            ...
            <Media
              ...
              link="https://www.coingecko.com/en/coins/liquid-staking-derivative"
            />
          </div>
        </div>
      </div>
